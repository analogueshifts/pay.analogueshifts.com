...
export default function CreatePayment() {
  ...
  // Ensure the component only accesses the router when mounted on the client
  useEffect(() => {
  ...
  return (
    <div className="mt-5">
      <input
        type="text"
        name="title"
        className="capitalize mb-3 w-full h-10 border rounded-full border-black"
        placeholder="Title"
      ...
      <input
        type="text"
        name="description"
        className="mb-3 w-full h-10 border rounded-full border-black"
