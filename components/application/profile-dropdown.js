        ...
        {isOpen && (
          ...
          >
            <RenderMenu
              item={{
                title: "Wallet",
                description: "Overview of your acount.",
                image: "/images/guest-layout/profile/dashboard.svg",
            ...
            <RenderMenu
              item={{
                ...
                image: "/images/guest-layout/profile/hire.svg",
                action: () => router.push("/banks/add"),
              }}
            />
            <RenderMenu
              item={{
                ...
                image: "/images/guest-layout/profile/logout.svg",
                action: handleLogout,
              }}
            />
          </motion.div>
