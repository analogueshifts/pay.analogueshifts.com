...
const Navigation = ({ user }) => {
  ...
  return (
    ...
    >
      ...
      <nav className="bg-white max-w-[1600px] absolute z-30 h-20 large:h-104 px-[112px] tablet:px-6 flex items-center justify-between w-full  ">
        ...
        <div className="hidden items-center gap-7 large:gap-10 lg:flex">
          ...
          <NavLink
            href="https://www.analogueshifts.com/direct-hire"
          ...
          <NavLink
            href="https://www.analogueshifts.com/jobs"
            active={pathname.startsWith("/jobs")}
          >
            Jobs
          </NavLink>

          <NavLink href="https://blog.analogueshifts.com">Blog</NavLink>

          <NavLink
            href="https://www.analogueshifts.com/about"
        ...
        {user ? (
          ...
          <div className="hidden lg:flex lg:items-center gap-6">
            <NavLink href="https://auth.analogueshifts.app?app=pay">
              Login
            </NavLink>
            <Link
              ...
              href="https://auth.analogueshifts.app?app=pay"
            >
              Sign Up
            </Link>
          </div>
